...
_CSS Transforms_  are a way to turn your flat, blocky CSS page elements into easier-to-manipulate objects. Think of it as a way to turn a Microsoft Word Document into an Adobe Illustrator document.
...
Use the provided template to create an interactive composition. The composition should:
